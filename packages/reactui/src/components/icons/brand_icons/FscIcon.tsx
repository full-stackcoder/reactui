...
const FscIcon = ({ fill, className, ...props }: IconProps) => {
  const classNames = ['fscFullStackCoderIcon', className && `${className}`].filter(Boolean).join(' ')
  return (
    <svg
      {...props}
...
export default withLayout(FscIcon)
