...
const OutlinedIcon = ({ fill, className, ...props }: IconProps) => {
  const classNames = ['fscMobile_outlinedIcon', className && `${className}`].filter(Boolean).join(' ')
  return (
    <svg {...props} className={classNames} xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1200 1200'>
      <title>Mobile Outlined Icon</title>
      <metadata>Created by Prashan Pudasaini on October 20th 2022.</metadata>
...
const MobileOutlinedIcon = withLayout(OutlinedIcon)

export { MobileOutlinedIcon }
