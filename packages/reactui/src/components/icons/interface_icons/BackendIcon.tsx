...
const OutlinedIcon = ({ fill, className, ...props }: IconProps) => {
  const classNames = ['fscBackend_outlinedIcon', className && `${className}`].filter(Boolean).join(' ')
  return (
    <>
...
const BackendOutlinedIcon = withLayout(OutlinedIcon)

export { BackendOutlinedIcon }
