...
const OutlinedIcon = ({ fill, className, ...props }: IconProps) => {
  const classNames = ['fscPassword_outlinedIcon', className && `${className}`].filter(Boolean).join(' ')
  return (
    <svg
      {...props}
...
const PasswordOutlinedIcon = withLayout(OutlinedIcon)

export { PasswordOutlinedIcon }
